...
import ProductionHubSidebar from './ProductionHubSidebar';
...
interface ProductionHubDashboardProps {
...
const viewDescriptions: { [key: string]: string } = {
    home: 'Centralized interface for monitoring all ongoing productions.',
    projects: 'Manage all project details, from synopsis to casting.',
    phases: 'Define and track production timelines and milestones.',
    tasks: 'Assign and monitor tasks for all productions.',
    slate: 'Use the digital timecode slate for logging takes.',
...
const ProductionHubDashboard: React.FC<ProductionHubDashboardProps> = ({ user, onLogout }) => {
    ...
    const currentDescription = viewDescriptions[activeView] || 'Manage your production content efficiently.';

    return (
        <div className="flex min-h-screen bg-[var(--bg-secondary)] text-[var(--text-primary)]">
            <ProductionHubSidebar user={user} onLogout={handleLogout} activeView={activeView} setActiveView={setActiveView} />
...
export default ProductionHubDashboard;